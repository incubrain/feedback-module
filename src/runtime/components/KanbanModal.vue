  ...
  <UCard :ui="{ ring: '', divide: 'divide-y divide-gray-100 dark:divide-gray-800' }">
    <template #header>
      <div class="flex items-center justify-between bg-green-700 text-white p-4 rounded-t-md">
        <h3 class="text-base font-semibold leading-6">{{ feedback.title }}</h3>
        <UButton
          color="gray"
          variant="ghost"
    ...
    <div class="w-full mb-2">
      ...
      <p class="text-sm text-gray-400 dark:text-gray-200 font-semibold">{{ feedback.body }}</p>
    </div>
